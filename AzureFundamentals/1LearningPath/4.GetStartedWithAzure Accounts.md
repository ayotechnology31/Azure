...
You can purchase Azure access directly from Microsoft by signing up on the Markup :  [Named Link](https://azure.microsoft.com/en-us/ "Azure website")  or through a Microsoft representative. You can also purchase Azure access through a Microsoft partner. Cloud Solution Provider partners offer a range of complete managed-cloud solutions for Azure.

For more information on how to create an Azure account, see the Markup :  [Named Link](https://docs.microsoft.com/en-us/learn/modules/create-an-azure-account/") learning module.
